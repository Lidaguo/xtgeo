...
%numpy_typemaps(bool, NPY_BOOL, long)
...
//======================================================================================
// Magic typemaps (cf xtgeo/xtgeo.h)
//======================================================================================
...
%apply (bool* INPLACE_ARRAY_FLAT, long DIM_FLAT)
    {(bool *swig_np_boo_inplaceflat_v1, long n_swig_np_boo_inplaceflat_v1)};

// INPLACE_FLAT BOOL no 2
%apply (bool* INPLACE_ARRAY_FLAT, long DIM_FLAT)
    {(bool *swig_np_boo_inplaceflat_v2, long n_swig_np_boo_inplaceflat_v2)};
